 ...
 * 网格百分比布局
 */
public class PercentGrideLayout extends GridLayout {

    //布局帮助类
    private PercentLayoutHelper mHelper;

    public PercentGrideLayout(Context context) {
        this(context, null);
    }

    public PercentGrideLayout(Context context, AttributeSet attrs) {
     ...
     * 布局参数
     */
    public static class LayoutParams extends GridLayout.LayoutParams implements
