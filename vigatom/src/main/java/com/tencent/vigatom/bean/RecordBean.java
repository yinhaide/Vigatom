...
/**
 * 记录日志的Bean
 * 日志路径：mnt/sdcard/Android/data/<package name>/files/vigatom/<date>/xx
 */
public class RecordBean extends ViBean {

    //是否允许记录崩溃日志(mnt/sdcard/Android/data/<package name>/files/vigatom/<date>/crash.log)
    private boolean crashEnable;
    //是否允许记录崩溃日志(mnt/sdcard/Android/data/<package name>/files/vigatom/<date>/inner.log)
    private boolean innerEnable;
    //是否允许记录崩溃日志(mnt/sdcard/Android/data/<package name>/files/vigatom/<date>/outer.log)
